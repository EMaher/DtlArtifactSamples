...
function Invoke-Process
{
    ...
    try
    {
        ...
        elseif ($exitCode -gt 0) # Determine if process failed to execute.
        {
...
function Get-WebPlatformInstallerExePath
{
    [CmdletBinding()]
    param()

    $wpiInfo = (Get-ChildItem "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\WebPlatformInstaller")[-1].Name
